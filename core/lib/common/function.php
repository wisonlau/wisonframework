 ...
 * @param mixed $default_filter 默认参数过滤方法 用于I函数...
 * @return mixed
 */
function Request($name,$default='',$filter=null,$datas=null,$var_auto_string=false,$url_pathinfo_depr='/',$default_filter='htmlspecialchars') {
    static $_PUT	=	null;
